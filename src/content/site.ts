...
// solo cambiaba el hash de la URL actual sin ir a ningún lado. Se renderizan
// como <a> normales, NO como <Link> de next/link: el router de cliente de
// Next.js concatenó mal dos navegaciones por hash seguidas en producción
// (URLs corruptas como "/#contacto#paquetes"). Un <a> corriente delega la
// navegación entre páginas al navegador, que sí reemplaza el hash siempre.
export const topbar = {
